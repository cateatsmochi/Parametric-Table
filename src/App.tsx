...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-[#f9f9f9] text-black font-['Space_Grotesk'] overflow-hidden select-none">
      ...
      <AnimatePresence>
        {quoteResult && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-8 bg-black/40 backdrop-blur-sm">
            <motion.div 
            ...
            >
              <div className="bg-black text-white px-4 py-1 md:py-2 flex justify-between items-center h-8 md:h-10 shrink-0">
                ...
                <button 
                  ...
                  className="bg-[#c6c6c6] text-black h-5 w-5 md:h-6 md:w-6 flex items-center justify-center shadow-[inset_1px_1px_0px_0px_#ffffff,inset_-1px_-1px_0px_0px_#808080] hover:bg-red-500 hover:text-white"
                >
                  <X size={12} />
                </button>
              </div>
                ...
                <div className="flex-1 flex flex-col gap-2 md:gap-4 justify-between">
                  ...
                  <div className="flex gap-1.5 pt-2">
                    <button 
                      ...
                      className="flex-1 bg-black text-white py-1.5 md:py-3 font-bold text-[9px] uppercase tracking-wider hover:bg-gray-800"
                    >
                      Export
                    </button>
      ...
      {/* Top Bar */}
      <header className="h-8 md:h-10 border-b-2 border-white shadow-[inset_-1px_-1px_0px_0px_#808080] flex justify-between items-center px-2 z-50 bg-[#f9f9f9]">
            ...
            <div className={cn("flex gap-2", isMobile ? "flex-row items-stretch" : "flex-col")}>
              ...
              <div className={cn("flex gap-2", isMobile ? "flex-row shrink-0" : "flex-col space-y-2")}>
                <button 
                  ...
                  className={cn(
                    "bg-black text-white font-bold uppercase tracking-widest hover:bg-gray-800 active:translate-x-[1px] active:translate-y-[1px] flex items-center justify-center transition-all",
